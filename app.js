...
const categoryMap = {
  "งานสนับสนุนห้องเรียนและห้องปฏิบัติการ": [
    ...
    "เปิด/ปิดห้องประชุม Online/Onsite",
    "อื่น ๆ",
  ],
  ...
  "งานบริการผู้ใช้และ Help Desk ภายใน": [
    ...
    "อบรมบริการวิชาการที่คณะจัด",
    "อื่น ๆ",
  ],
  "งานเครือข่ายและโครงสร้างพื้นฐาน": [
    "ติดตั้งระบบ/เครือข่าย",
    "แก้ปัญหาระบบเครือข่าย",
    "จัดการหมายเลข IP",
    "จัดการ DNS",
    "อื่น ๆ",
  ],
  "งานระบบสารสนเทศ บัญชีผู้ใช้ และความปลอดภัย": [
    ...
    "จัดการสิทธิ์การเข้าถึงบริการ",
    "ตรวจสอบ/แก้ปัญหาความปลอดภัย",
    "อื่น ๆ",
  ],
  "งานเอกสาร": [
...
function makeSatisfactionUrl(logId) {
  return `${getAppBasePath()}satisfaction.html?v=20260721-04&log_id=${encodeURIComponent(logId)}`;
}
